...
def run_test():
    ...
    tester.test_return("Space is non-periodic",True,False,InfiniteVaccuum.is_periodic)
    ...
    tester.test_return("Hexagonal cell is periodic",True,True,HexCell.is_periodic)

    tester.test_return("Inequality operator works",True,True,HexCell.__ne__,InfiniteVaccuum)

    HexCell2=psr.Space(HexCell)
    tester.test_return("Copy constructor works",True,True,HexCell.__eq__,HexCell2)
