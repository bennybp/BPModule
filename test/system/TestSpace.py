...
InfiniteVaccuum=psr.system.Space()
Infinite=[psr.system.Space.infinity for i in range(0,3)]
Sides=[2.0,2.0,2.0]
ra=math.pi/2
...
HexCell=psr.system.Space(Hexagonal,Sides)
...
HexCell2=psr.system.Space(HexCell)
