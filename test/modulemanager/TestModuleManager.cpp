...
TEST_SIMPLE(TestModuleManager){
    ...
    tester.test_member_return("has non-existent module",true,false,&ModuleManager::has_key,&mm,mod_name);
    tester.test_member_call("No path causes failure",false,load_module,&mm,minfo,mod_name);
    ...
    tester.test_member_return("module key info non-existent key",false,minfo,
    ...
    //This test bricks the MM afterwards as no more nodes can be added...
