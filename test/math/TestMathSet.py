...
tester.test("union fail",False,S9,S1.set_union,S99)
tester.test("union assign",True,S9,S1.union_assign,S12)
tester.test("union assign fail",False,S9,S1.union_assign,S99)
tester.test("intersection",True,S12,S1.intersection,S10)
tester.test("intersection fail",False,S2,S1.intersection,S99)
tester.test("intersection assign",True,S12,S1.intersection_assign,S10)
tester.test("intersection assign fail",False,S2,S1.intersection_assign,S99)
tester.test("difference",True,S13,S2.difference,S12)
tester.test("difference fail",False,S13,S2.difference,S99)
tester.test("difference assign",True,S13,S2.difference_assign,S12)
tester.test("difference assign fail",False,S13,S2.difference_assign,S99)
