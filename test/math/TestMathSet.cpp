...
TEST_SIMPLE(TestMathSet){
    ...
    tester.test_return("idx valid",true,2,idx_fxn,S8,3.0);
    tester.test_call("idx invalid",false,idx_fxn,S8,55.0);
    auto idx_fxn2=bind(&MathSet_t::insert,_1,_2);
    MathSet_t S11(U1,{2,3});
    tester.test_return("insert by valid elem",true,S11,idx_fxn2,S1,4.0);
    tester.test_call("insert by invalid elem",false,idx_fxn2,S1,55.0);
    auto idx_fxn3=bind(&MathSet_t::insert_idx,_1,_2);
    tester.test_return("insert by valid index",true,S11,idx_fxn3,S2,3);
    tester.test_call("insert by invalid index",false,idx_fxn3,S2,99);
    ...
    tester.test_return("union",true,S9,un2,S1,S12);
    tester.test_call("union fail",false,un2,S1,S99);
    tester.test_return("union assign",true,S9,un1,S1,S12);
    tester.test_call("union assign fail",false,un1,S1,S99);
    auto int1=bind(&MathSet_t::intersection_assign,_1,_2);
    auto int2=bind(&MathSet_t::intersection,_1,_2);
    tester.test_return("intersection",true,S12,int2,S1,S10);
    tester.test_call("intersection fail",false,int2,S1,S99);
    tester.test_return("intersection assign",true,S12,int1,S1,S10);
    tester.test_call("intersection assign fail",false,int1,S1,S99);
    auto diff1=bind(&MathSet_t::difference_assign,_1,_2);
    auto diff2=bind(&MathSet_t::difference,_1,_2);
    tester.test_return("difference",true,S13,diff2,S2,S12);
    tester.test_call("difference fail",false,diff2,S2,S99);
    tester.test_return("difference assign",true,S13,diff1,S2,S12);
    tester.test_call("difference assign fail",false,diff1,S2,S99);
    ...
    tester.test_return("subset equal",true,true,subs,S2,S13);
    tester.test_return("subset true",true,true,subs,S2,S9);
    tester.test_return("subset false",true,false,subs,S9,S2);
    auto subs2=bind(&MathSet_t::is_proper_subset_of,_1,_2);
    tester.test_return("proper subset equal",true,false,subs2,S2,S13);
    tester.test_return("proper subset true",true,true,subs2,S2,S9);
    tester.test_return("proper subset false",true,false,subs2,S9,S2);
    auto sups=bind(&MathSet_t::is_superset_of,_1,_2);
    tester.test_return("superset equal",true,true,subs,S2,S13);
    tester.test_return("superset true",true,true,sups,S9,S2);
    tester.test_return("superset false",true,false,sups,S2,S9);
    auto sups2=bind(&MathSet_t::is_proper_superset_of,_1,_2);
    tester.test_return("proper superset equal",true,false,sups2,S2,S13);
    tester.test_return("proper superset true",true,true,sups2,S9,S2);
    tester.test_return("proper superset false",true,false,sups2,S2,S9);
