...
/////////////////////////////////////////////
inline
GenericHolder<SerializedGenericData>::GenericHolder(const SerializedGenericData & m)
    : obj(std::make_shared<const SerializedGenericData>(m))
{ }

inline
GenericHolder<SerializedGenericData>::GenericHolder(SerializedGenericData && m)
