...
PYBIND11_PLUGIN(datastore)
{
    ...
    .def("HasSystem", &Wavefunction::HasSystem)
    ...
    .def("HasCMat", &Wavefunction::HasCMat)
    ...
    .def("HasEpsilon", &Wavefunction::HasEpsilon)
    ...
    .def("HasOccupations", &Wavefunction::HasOccupations)
